...
// RegisterRequestID is a middleware that injects a request UserID into the context of each
// request. A request UserID is a string of the form "host.example.com/random-0001",
// where "random" is a base62 random string that uniquely identifies this go
// process, and where the last number is an atomically incremented request
// counter.
func RegisterRequestID(runtime runtime.Runtime) server.HttpServerMiddleware {
  return &ExampleMiddleware{name: "request_id", runtime: runtime}
}
...
func (e *RequestID) Apply(h http.HandlerFunc) http.HandlerFunc {
...
func (e *RequestID) Order() int {
  return 0
}

func (e *RequestID) Kind() server.KindMiddleware {
  return e.name
}
