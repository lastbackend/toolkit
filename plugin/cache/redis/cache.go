...
func (c *redisCache) Flags() []cmd.Flag {
	return []cmd.Flag{
		&cmd.StringFlag{
			...
			EnvVar:      c.withEnvPrefix("ENDPOINTS"),
		...
		&cmd.StringFlag{
			...
			EnvVar:      c.withEnvPrefix("USERNAME"),
		...
		&cmd.StringFlag{
			...
			EnvVar:      c.withEnvPrefix("PASSWORD"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("HEARNEAT_FREQUENCY"),
		...
		&cmd.IntFlag{
			...
			EnvVar:      c.withEnvPrefix("MAX_RETRIES"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("MIN_RETRY_BACKOFF"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("MAX_RETRY_BACKOFF"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("DIAL_TIMEOUT"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("READ_TIMEOUT"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("WRITE_TIMEOUT"),
		...
		&cmd.IntFlag{
			...
			EnvVar:      c.withEnvPrefix("POOL_SIZE"),
		...
		&cmd.IntFlag{
			...
			EnvVar:      c.withEnvPrefix("MIN_IDLE_CONNS"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("MAX_CONN_AGE"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("POOL_TIMEOUT"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("IDLE_TIMEOUT"),
		...
		&cmd.DurationFlag{
			...
			EnvVar:      c.withEnvPrefix("IDLE_CHECK_FREQUENCY"),
