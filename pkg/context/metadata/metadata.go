...
func DeleteContextValue(ctx context.Context, k string) context.Context {
	return SetContextValue(ctx, k, emptyString)
}

func SetContextValue(ctx context.Context, k, v string) context.Context {
